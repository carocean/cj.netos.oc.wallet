...
@CjOpenports(usage = "在订单出入账单")
public interface IOnorderBillPorts extends IOpenportService {
    @CjOpenportAppSecurity
    @CjOpenport(usage = "分页账单，倒序",tokenIn = AccessTokenIn.nope)
    List<OnorderBill> pageBill(ISecuritySession securitySession,
    ...
    List<OnorderBill> monthBill(ISecuritySession securitySession,
                               @CjOpenportParameter(usage = "公众", name = "person") String person,
